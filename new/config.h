...
static const char normbgcolor[]     = "#005f00";
...
static const char *xrand1[] = {"xrandr", "--output", "eDP1", "--auto", NULL};
static const char *xrand2[] = {"xrandr", "--output", "eDP1", "--off", NULL};
...
static Key keys[] = {
    ...
    /* Function keys (backlight, volume)                                        */
