...
static const char col_orange[]      = "#a55f00";
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_orange, "-nf", col_gray3, "-sb", col_gray4, "-sf", col_gray1, NULL };
